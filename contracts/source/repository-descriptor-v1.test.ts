...
import { RepositoryDescriptorV1 } from "./repository-descriptor-v1.js";
...
const manifest = JSON.parse(
  await readFile(new URL("fixtures/repository-descriptor/v1/manifest.json", contractsRoot), "utf8"),
) as FixtureManifest;

const decode = Schema.decodeUnknownEither(RepositoryDescriptorV1, {
