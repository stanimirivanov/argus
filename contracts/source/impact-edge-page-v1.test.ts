...
import { ImpactEdgePageV1 } from "./impact-edge-page-v1.js";
...
const manifest = JSON.parse(
  await readFile(new URL("fixtures/impact-edge-page/v1/manifest.json", contractsRoot), "utf8"),
) as FixtureManifest;
const decode = Schema.decodeUnknownEither(ImpactEdgePageV1, { onExcessProperty: "error" });
