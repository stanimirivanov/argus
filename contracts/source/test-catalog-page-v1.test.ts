...
import { TestCatalogPageV1 } from "./test-catalog-page-v1.js";
...
const manifest = JSON.parse(
  await readFile(new URL("fixtures/test-catalog-page/v1/manifest.json", contractsRoot), "utf8"),
) as FixtureManifest;

const decode = Schema.decodeUnknownEither(TestCatalogPageV1, {
